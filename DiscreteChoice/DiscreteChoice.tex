...
\begin{itemize}
 \item A limitation of the conditional logit and multinomial logit is that discrimination among the m alternatives reduces to a series of pairwise comparisons that are unaffected by the characteristics of alternatives other than the pair under consideration. 
...
\end{itemize}
\item Need simulation to compute the choice probabilities and the likelihood. 
\end{frame}
